...
//var_dump($user); affiche le contenu d'un tab
...
$articles = array(
    array(
        ...
        'image' => 'https://picsum.photos/1500/?random=1',
        'image_alt' => 'Une super image qui sert à illustrer mon super article',
        'image_copyright' => 'Photo by @nobody',
    ),
    array(
        ...
        'image' => 'https://picsum.photos/1500/?random=2',
        'image_alt' => 'Une super image qui sert à illustrer mon super article',
        'image_copyright' => 'Photo by @nobody',
    ),
    array(
        ...
        'image' => 'https://picsum.photos/1500/?random=3',
        'image_alt' => 'Une super image qui sert à illustrer mon super article',
        'image_copyright' => 'Photo by @nobody',
    ),
    array(
        ...
        'date' => 'Le 28/12/2020',
        'image' => 'https://picsum.photos/1500/?random=4',
        'image_alt' => 'Une super image qui sert à illustrer mon super article',
        'image_copyright' => 'Photo by @nobody',
    ),
);
...
for ($i = 0; $i <= 3; $i++) {
    ...
    echo '<img src="' . $articles[$i]['image'] . '" alt="' . $articles[$i]['image_alt'] . '">' . '<br/ >';
    echo $articles[$i]['image_copyright'] . '<br/ >';
    echo '<br/ ><br/ >';
}
echo "<br>";
